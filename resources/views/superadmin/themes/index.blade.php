<x-layouts.superadmin>
    <div class="space-y-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Manage WordPress theme packages and plan restrictions.
                </p>
            </div>

            <a href="{{ route('superadmin.themes.create') }}"
        ...
        <form method="GET"
              class="grid gap-3 rounded-2xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900 lg:grid-cols-4">
            <input
                name="search"
                value="{{ $search ?? '' }}"
                        ...
                        @forelse ($themes as $theme)
                            <tr>
                                ...
                                <td class="px-4 py-3 text-right">
                                    <a href="{{ route('superadmin.themes.show', $theme) }}"
