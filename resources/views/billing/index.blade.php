                ...
                <div class="xl:col-span-2 space-y-8">
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl border border-gray-200">
                        <div class="px-6 py-5 border-b border-gray-100">
                            <h3 class="text-lg font-semibold text-gray-900">Start Subscription</h3>
                            <p class="mt-1 text-sm text-gray-500">
                            ...
                            @else
                                <form method="POST" action="{{ route('billing.checkout') }}" class="space-y-6">
                                    ...
                                    <div>
                                        <button
                                            type="submit"
                                            class="inline-flex items-center rounded-xl bg-indigo-600 px-5 py-3 text-sm font-semibold text-white hover:bg-indigo-700 transition"
                                        >
                                            Continue to Payment
                                        </button>
                                    </div>
